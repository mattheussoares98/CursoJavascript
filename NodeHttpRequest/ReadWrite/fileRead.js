...
// leitura sincrona => não é bom usar dessa forma porque o sistema vai ficar
//esperando terminar a leitura pra continuar com a execução do código e se a
//leitura demorar, pode vai ficar muito tempo executando a leitura

const contents = fs.readFileSync(path, "utf-8")
console.log("leitura assíncrona => ", contents)


//leitura assíncrona => utilize dessa forma abaixo pois é melhor quando terminar
//a leitura do arquivo, vai executar a callback que está no terceiro parâmetro
